...
def test_fim_c_RAS_subcase1(test_name,load_scenario_data,scenarios,run_curl_command,read_tif,fetch_directory_details,fetch_data_file_details,fetch_source_destination_details,remove_file):
    counter = 0
    tn = test_name + '.json'
    folder_name = 'PI6/data'
