...
def test_fim_c_TP_B_4_FIMC_HAND_subcase1(test_name,load_scenario_data,scenarios,fetch_docker_details,run_docker_script,fetch_data_file_details,run_shell_script_from_directory,remove_file):
    tn = test_name + '.json'
