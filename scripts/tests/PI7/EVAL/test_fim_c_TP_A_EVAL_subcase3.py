...
def test_fim_c_TP_A_EVAL_subcase3(test_name,load_scenario_data,scenarios,fetch_docker_details,run_docker_script,read_csv,fetch_data_file_details,remove_file):
    tn = test_name + '.json'
